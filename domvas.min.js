...
(function() {
  function t(t, n, r) {
    ...
    if (e) t.style.cssText = i.cssText;
      ...
      for (var s in i) isNaN(parseInt(s, 10)) && typeof i[s] != "function" &&
        !/^(cssText|length|parentRule)$/.test(s) && (t.style[s] = i[s])
  }
  ...
  function n(e, n) {
    ...
    t(e, n, 1), Array.prototype.forEach.call(r, function(e, n) {
        t(e, i[n])
      }), e.style.margin = e.style.marginLeft = e.style.marginTop = e.style.marginBottom =
      e.style.marginRight = ""
  }
  ...
  window.domvas = {
    toImage: function(e, t, r, i, s, o) {
      ...
      var a = (new XMLSerializer).serializeToString(u),
        ...
        ((r || e.offsetWidth) + s) + "' height='" + ((i || e.offsetHeight) +
          o) + "'>" + "<foreignObject width='100%' height='100%' x='" + s +
        "' y='" + o + "'>" + a + "</foreignObject>" + "</svg>",
        l = new Image;
